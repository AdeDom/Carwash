...
class LocalStorageProvider : DocumentsProvider() {
    ...
    override fun queryRoots(projection: Array<String>): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_user)
    ...
    override fun createDocument(
        ...
        try {
            ...
            Log.e(
                LocalStorageProvider::class.java.simpleName,
                "Error creating new file $newFile"
            )
        }
        return null
    }
